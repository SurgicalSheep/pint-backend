...
router.get('/percentSalasUtilizadas',verifyAccessToken,reservaController.salasUtilizadasPercent)
router.get('/alocacaoMensal',verifyAccessToken,reservaController.salasAlocacaoMensal)
